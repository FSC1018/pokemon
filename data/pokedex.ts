export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	pikachu: {
		...
		otherFormes:  ["Pikachu", "Pikachu-Starter", "Pikachu-World"],
		formeOrder: [
			"Pikachu",
	...
	eevee: {
		...
		weightkg: 6.5,
		color: "Brown",
		evos: ["Vaporeon", "Jolteon", "Flareon", "Espeon", "Umbreon", "Leafeon", "Glaceon", "Sylveon", "Shadeon","Eeveeon"],
		eggGroups: ["Field"],
	...
	vaporeon: {
		...
		evoType: "useItem",
		evoItem: "Water Stone",
		evos: ["Elyteon","Scaldeon","Pearleon","Deepseon","Swampeon", "Slusheon", "Nympheon", "Fogeon","Vaporex"],
		eggGroups: ["Field"],
	},
	jolteon: {
		num: 135,
		...
		evoType: "useItem",
		evoItem: "Thunder Stone",
		evos: ["Elyteon","Plasmeon”, “Radeon”, “Desoleon”, “Scourgeon” ,”Stormeon”, Twinkleon”, “Spectreon","Joltex"],
		eggGroups: ["Field"],
	},
	flareon: {
		num: 136,
		...
		evoType: "useItem",
		evoItem: "Fire Stone",
		evos: ["Scaldeon","Plasmeon”, “Angreon”, “Strifeon”, “Sageon” ,”Thermeon” ,”Pranceon”, “Wispeon","Flarex"],
		eggGroups: ["Field"],
	},
	porygon: {
		num: 137,
	...
	espeon: {
		...
		evoType: "useItem",
		evoItem: "Sun Stone",
		evos: ["Pearleon","Radeon”, “Angreon”, “Contrareon”, “Lusheon” ,”Freezeon” ,”Somneon”, “Mareon","Espex"],
		eggGroups: ["Field"],	
	},
	umbreon: {
		num: 197,
		...
		evoType: "useItem",
		evoItem: "Moon Stone",
		evos: ["Deepseon","Desoleon", "Strifeon", "Contrareon", "Carniveon" ,"Crypteon" ,"Luneon", "Nocturneon","Umbrex"],
		eggGroups: ["Field"],
	},
	murkrow: {
		num: 198,
	...
	leafeon: {
		...
		evoType: "useItem",
		evoItem: "Leaf Stone",
		evos: ["Swampeon","Scourgeon", "Sageon", "Lusheon", "Carniveon" ,"Mintheon" ,"Dryadeon", "Withereon","Leafex"],
		eggGroups: ["Field"],
	},
	glaceon: {
		num: 471,
		...
		evoType: "useItem",
		evoItem: "Ice Stone",
		evos: ["Slusheon","Stormeon", "Thermeon", "Freezeon", "Crypteon" ,"Mintheon" ,"Wondreon","Yukieon","Glacex"],
		eggGroups: ["Field"],
	},
	gliscor: {
		num: 472,
	...
	yamask: {
		...
		abilities: {0: "Mummy", 1: "Ecto Shift"},
		heightm: 0.5,
		weightkg: 1.5,
		color: "Black",
		evos: ["Cofagrigus"],
	...
	yamaskgalar: {
		...
		abilities: {0: "Wandering Spirit", 1: "Ecto Shift"},
		heightm: 0.5,
		weightkg: 1.5,
		color: "Black",
		evos: ["Runerigus"],
	...
	sylveon: {
		...
		evoType: "useItem",
		evoItem: "Shiny Stone",
		evos: ["Nympheon","Twinkleon", "Pranceon", "Somneon", "Luneon" ,"Dryadeon" ,"Wondreon", "Spriteon", "Sylvex"],
		eggGroups: ["Field"],
	},
	hawlucha: {
		num: 701,
	...
	shadeon: {
		...
		types: ["Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 65, def: 130, spa: 110, spd: 95, spe: 60},
		abilities: {0: "Cursed Body", H: "Ecto Shift"},
		heightm: 1,
		weightkg: 29,
		color: "Grey",
		prevo: "Eevee",
		evoType: "useItem",
		evoItem: "Dusk Stone",
		evos: ["Fogeon","Spectreon", "Wispeon", "Mareon", "Nocturneon" ,"Withereon" ,"Yukieon", "Spriteon","Shadex"],
		eggGroups: ["Field"],
	},
	elyteon: {
		num: 907,
		...
		types: ["Water", "Electric"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 70, def: 60, spa: 110, spd: 100, spe: 110},
		abilities: {0: "Volt Absorb",1: "Water Asorb", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Jolteon"},
		evoType: "useItem",
		evoItem: {"Thunder Essence","Water Essence"},
		eggGroups: ["Field"],
	},
	...
	scaldeon: {
		...
		types: ["Water", "Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 130, def: 60, spa: 110, spd: 100, spe: 70},
		abilities: {0: "Water Absorb",1: "Flash Fire", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Flareon"},
		evoType: "useItem",
		evoItem: {"Water Essence","Fire Essence"},
		eggGroups: ["Field"],
	},
  pearleon: {
		num: 909,
		...
		types: ["Water", "Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130,atk: 70, def: 60, sta: 130, std: 110, spe: 100},
		abilities: {0: "Water Absorb",1: "Magic Bounce", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Espeon"},
		evoType: "useItem",
		evoItem: {"Water Essence","Psychic Essence"},
		eggGroups: ["Field"],
	},
  deepseon: {
		num: 910,
		...
		types: ["Water", "Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 60, def: 110,spa: 100, spd: 130, spe: 70},
		abilities: {0: "Water Absorb",1: "Inner Focus", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Umbreon"},
		evoType: "useItem",
		evoItem: {"Water Essence","Dark Essence"},
		eggGroups: ["Field"],
	},
  swampeon: {
		num: 911,
		...
		types: ["Water", "Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 110, def: 130, spa: 100, spd: 70, spe: 60},
		abilities: {0: "Water Absorb",1: "Leaf Guard", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Leafeon"},
		evoType: "useItem",
		evoItem: {"Water Essence","Leaf Essence"},
		eggGroups: ["Field"],
	},
 slusheon: {
		num: 912,
		...
		types: ["Water", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 60, def: 110, spa: 130, spd: 100, spe: 70},
		abilities: {0: "Water Absorb",1: "Snow Cloak", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Glaceon"},
		evoType: "useItem",
		evoItem: {"Water Essence","Ice Essence"},
		eggGroups: ["Field"],
	},
  ...
  nympheon: {
		...
		types: ["Water", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 70, def:, 60, spa: 110, spd: 130, spe: 100},
		abilities: {0: "Water Absorb",1: "Cute Charm", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Sylveon"},
		evoType: "useItem",
		evoItem: {"Water Essence","Fairy Essence"},
		eggGroups: ["Field"],
	},
 fogeon: {
		num: 914,
		...
		types: ["Water", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 70, def: 130, spa: 110, spd: 100, spe: 60},
		abilities: {0: "Water Absorb",1: "Cursed Body", H: "Hydration"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Vaporeon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Water Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
	plasmeon: {
		num: 915,
		...
		types: ["Electric", "Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 130, def: 60, spa: 110, spd: 100, spe: 130},
		abilities: {0: "Volt Absorb",1: "Flash Fire", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Jolteon","Flareon"},
		evoType: "useItem",
		evoItem: {"Electric Essence","Fire Essence"},
		eggGroups: ["Field"],
	},
radeon: {
		num: 916,
		...
		types: ["Electric", "Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 70, def: 60, spa: 130, spd: 110, spe: 130},
		abilities: {0: "Volt Absorb",1: "Magic Bounce", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Jolteon","Espeon"},
		evoType: "useItem",
		evoItem: {"Electric Essence","Psychic Essence"},
		eggGroups: ["Field"],
	},
desoleon: {
		num: 917,
		...
		types: ["Electric", "Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 110, spa: 100, spd: 130, spe: 130},
		abilities: {0: "Volt Absorb",1: "Inner Focus", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Jolteon","Umbreon"},
		evoType: "useItem",
		evoItem: {"Electric Essence","Dark Essence"},
		eggGroups: ["Field"],
	},
scourgeon: {
		num: 918,
		...
		types: ["Electric", "Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 110, def: 130, spa: 100, spd: 70, spe: 130},
		abilities: {0: "Volt Absorb",1: "Leaf Guard", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Jolteon","Leafeon"},
		evoType: "useItem",
		evoItem: {"Electric Essence","Leaf Essence"},
		eggGroups: ["Field"],
	},
stormeon: {
		num: 919,
		...
		types: ["Electric", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 110, spa: 130, spd: 100, spe: 130},
		abilities: {0: "Volt Absorb",1: "Snow Cloak", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Jolteon","Glaceon"},
		evoType: "useItem",
		evoItem: {"Electric Essence","Ice Essence"},
		eggGroups: ["Field"],
	},
...
twinkleon: {
		...
		types: ["Electric", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 70, def: 60, spa: 110, spd: 130, spe: 130},
		abilities: {0: "Volt Absorb",1: "Cute Charm", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Jolteon","Sylveon"},
		evoType: "useItem",
		evoItem: {"Electric Essence","Fairy Essence"},
		eggGroups: ["Field"],
	},
spectreon: {
		num: 921,
		...
		types: ["Electric", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 130, spa: 110, spd: 100, spe:130},
		abilities: {0: "Volt Absorb",1: "Cursed Body", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Jolteon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Electric Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
	angreon: {
		num: 922,
		...
		types: ["Fire", "Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 130, def: 60, spa: 130, spd: 100, spe: 110},
		abilities: {0: "Flash Fire",1: "Magic Bounce", H: "Guts"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Flareon","Espeon"},
		evoType: "useItem",
		evoItem: {"Fire Essence","Psychic Essence"},
		eggGroups: ["Field"],
	},
strifeon: {
		num: 923,
		...
		types: ["Fire", "Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 130, def: 110, spa: 100, spd: 130, spe: 60},
		abilities: {0: "Flash Fire",1: "Inner Focus", H: "Guts"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Flareon","Umbreon"},
		evoType: "useItem",
		evoItem: {"Fire Essence","Dark Essence"},
		eggGroups: ["Field"],
	},
sageon: {
		num: 924,
		...
		types: ["Fire", "Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 130, def: 130, spa: 100, spd: 100, spe: 70},
		abilities: {0: "Flash Fire",1: "Leaf Guard", H: "Guts"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Flareon","Leafeon"},
		evoType: "useItem",
		evoItem: {"Fire Essence","Leaf Essence"},
		eggGroups: ["Field"],
	},
thermeon: {
		num: 925,
		...
		types: ["Fire", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 130, def: 110, spa: 130, spd: 100, spe: 60},
		abilities: {0: "Flash Fire",1: "Snow Cloak", H: "Guts"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Flareon","Glaceon"},
		evoType: "useItem",
		evoItem: {"Fire Essence","Ice Essence"},
		eggGroups: ["Field"],
	},
...
pranceon: {
		...
		types: ["Fire", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 130, def: 70, spa: 110, spd: 130, spe: 60},
		abilities: {0: "Flash Fire",1: "Cute Charm", H: "Guts"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Flareon","Sylveon"},
		evoType: "useItem",
		evoItem: {"Fire Essence","Fairy Essence"},
		eggGroups: ["Field"],
	},
wispeon: {
		num: 927,
		...
		types: ["Fire", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 130, def: 130, spa: 110, spd: 100, spe: 60},
		abilities: {0: "Flash Fire",1: "Cursed Body", H: "Guts"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Flareon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Fire Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
	contrareon: {
		num: 928,
		...
		types: ["Psychic", "Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 110, spa: 130, spd: 130, spe: 100},
		abilities: {0: "Magic Bounce",1: "Inner Focus", H: "Contrary"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Espeon","Umbreon"},
		evoType: "useItem",
		evoItem: {"Psychic Essence","Dark Essence"},
		eggGroups: ["Field"],
	},
lusheon: {
		num: 929,
		...
		types: ["Psychic", "Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 110, def: 130, spa: 130, spd: 70, spe: 100},
		abilities: {0: "Magic Bounce",1: "Leaf Guard", H: "Chlorophyll"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Espeon","Leafeon"},
		evoType: "useItem",
		evoItem: {"Psychic Essence","Leaf Essence"},
		eggGroups: ["Field"],
	},
freezeon: {
		num: 930,
		...
		types: ["Psychic", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 130, spa: 130, spd: 100, spe: 110},
		abilities: {0: "Magic Bounce",1: "Snow Cloak", H: "Ice Body"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Espeon","Glaceon"},
		evoType: "useItem",
		evoItem: {"Psychic Essence","Ice Essence"},
		eggGroups: ["Field"],
	},
...
somneon: {
		...
		types: ["Psychic", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 70, def: 60, spa: 130, spd: 130, spe: 110},
		abilities: {0: "Magic Bounce",1: "Cute Charm", H: "Pixilate"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Espeon","Sylveon"},
		evoType: "useItem",
		evoItem: {"Psychic Essence","Fairy Essence"},
		eggGroups: ["Field"],
	},
mareon: {
		num: 932,
		...
		types: ["Psychic", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 130, spa: 130, spd: 110, spe:100},
		abilities: {0: "Magic Bounce",1: "Cursed Body", H: "Ecto Shift"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Espeon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Psychic Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
	carniveon: {
		num: 933,
		...
		types: ["Dark", "Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 110, atk: 100, def: 130, spa: 60, spd: 130, spe: 70},
		abilities: {0: "Inner Focus",1: "Leaf Guard", H: "Chlorophyll"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Umbreon","Leafeon"},
		evoType: "useItem",
		evoItem: {"Dark Essence","Leaf Essence"},
		eggGroups: ["Field"],
	},
crypteon: {
		num: 934,
		...
		types: ["Dark", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 60, def: 110, spa: 130, spd: 130, spe: 70},
		abilities: {0: "Inner Focus",1: "Snow Cloak", H: "Ice Body"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Umbreon","Glaceon"},
		evoType: "useItem",
		evoItem: {"Dark Essence","Ice Essence"},
		eggGroups: ["Field"],
	},
...
luneon: {
		...
		abilities: {0: "Inner Focus",1: "Cute Charm", H: "Pixilate"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Umbreon","Sylveon"},
		evoType: "useItem",
		evoItem: {"Dark Essence","Fairy Essence"},
		eggGroups: ["Field"],
	},
nocturneon: {
		num: 936,
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 70, def: 130, spa: 110, spd: 130, spe: 60},
		abilities: {0: "Inner Focus", 1: "Cursed Body", H: "Ecto Shift"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Umbreon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Dark Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
	mintheon: {
		num: 938,
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 110, def: 130, spa: 130, spd: 70, spe: 100},
		abilities: {0: "Leaf Guard",1: "Snow Cloak", H: "Chlorophyll"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Leafeon","Glaceon"},
		evoType: "useItem",
		evoItem: {"Grass Essence","Ice Essence"},
		eggGroups: ["Field"],
	},
...
dryadeon: {
		...
		types: ["Grass", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 110, def: 130, spa: 100, spd: 130, spe: 60},
		abilities: {0: "Leaf Guard",1: "Cute Charm", H: "Chlorophyll"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Leafeon","Sylveon"},
		evoType: "useItem",
		evoItem: {"Grass Essence","Fairy Essence"},
		eggGroups: ["Field"],
	},
withereon: {
		num: 940,
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 130, def: 130, spa: 110, spd: 100, spe: 60},
		abilities: {0: "Leaf Guard", 1: "Cursed Body", H: "Chlorophyll"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Leafeon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Grass Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
wondreon: {
		num: 941,
		...
		types: ["Ice", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 70, def: 110, spa: 130, spd: 130, spe: 60},
		abilities: {0: "Snowy Veil",1: "Cute Charm", H: "Ice Body"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Glaceon","Sylveon"},
		evoType: "useItem",
		evoItem: {"Ice Essence","Fairy Essence"},
		eggGroups: ["Field"],
	},
yukieon: {
		num: 942,
		...
		types: ["Ice", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 70, def: 130, spa: 130, spd: 110, spe: 60},
		abilities: {0: "Snowy Veil", 1: "Cursed Body", H: "Ice Body"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Glaceon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Ice Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
	spriteon: {
		num: 943,
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 70, def: 130, spa: 110, spd: 130, spe: 60},
		abilities: {0: "Cute Charm", 1: "Cursed Body", H: "Pixilate"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: {"Slyveon","Shadeon"},
		evoType: "useItem",
		evoItem: {"Fairy Essence","Ghost Essence"},
		eggGroups: ["Field"],
	},
	eeveeon: {
		num: 944,
		...
		abilities: {0: "Protean", 1: "Adaptability", H: "Anticipation"},
		heightm: 0.3,
		weightkg: 6.5,
		color: "Brown",
		prevo: ["Eevee"],
	...
	vaporex: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 145, atk: 87, def: 72, spa: 122, spd: 107, spe: 77},
		abilities: {0: "Water Absorb", H: "Hydration"},
		heightm: 1,
		weightkg: 29,
		color: "Blue",
	...
	joltex: {
		...
		types: ["Electric"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 77, atk: 77, def: 72, spa: 122, spd: 107, spe: 145},
		abilities: {0: "Volt Absorb", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
	...
	flarex: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 77, atk: 145, def: 72, spa: 107, spd: 122, spe: 77},
		abilities: {0: "Flash Fire", H: "Guts"},
		heightm: 0.9,
		weightkg: 25,
		color: "Red",
	...
	espex: {
		...
		types: ["Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 77, atk: 77, def: 72, spa: 145, spd: 107, spe: 122},
		abilities: {0: "Synchronize", H: "Magic Bounce"},
		heightm: 0.9,
		weightkg: 26.5,
		color: "Purple",
	...
	umbrex: {
		...
		types: ["Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 107, atk: 77, def: 122, spa: 72, spd: 145, spe: 77},
		abilities: {0: "Synchronize", H: "Inner Focus"},
		heightm: 1,
		weightkg: 27,
		color: "Black",
	...
	leafex: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 77, atk: 122, def: 145, spa: 72, spd: 77, spe: 107},
		abilities: {0: "Leaf Guard", H: "Chlorophyll"},
		heightm: 1,
		weightkg: 25.5,
		color: "Green",
	...
	glacex: {
		...
		types: ["Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 77, atk: 72, def: 122, spa: 145, spd: 107, spe: 77},
		abilities: {0: "Snow Cloak", H: "Ice Body"},
		heightm: 0.8,
		weightkg: 25.9,
		color: "Blue",
	...
	sylvex: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 107, atk: 77, def: 77, spa: 122, spd: 145, spe: 72},
		abilities: {0: "Cute Charm", H: "Pixilate"},
		heightm: 1,
		weightkg: 23.5,
		color: "Pink",
	...
	shadex: {
		...
		types: ["Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 77, atk: 77, def: 145, spa: 122, spd: 107, spe: 72},
		abilities: {0: "Cursed Body", H: "Ecto Shift"},
		heightm: 1,
		weightkg: 29,
		color: "Grey",
